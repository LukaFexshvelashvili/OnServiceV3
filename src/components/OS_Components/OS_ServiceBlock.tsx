...
export default function OS_ServiceBlock(props: {
  ...
  return (
    <div className="relative overflow-hidden group flex flex-col gap-2 w-[350px] items-center p-5 rounded-md transition-shadow  bg-transparent cursor-pointer hover:shadow-[8px_8px_15px_#4059fd34] group-hover:[&>svg]:bg-rose-900">
